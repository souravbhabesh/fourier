...
double avg_hFT[RUNS][NX+1];
double avg_h[RUNS][2*NX];
double hFT_width_avg[NX+1];//Averaging fourier amplitude square across runs
double error[NX+1]; //RMSE error in |hFT|^2
//int NX,NY;
//float KAPPA;
